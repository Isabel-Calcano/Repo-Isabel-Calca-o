...
n_payaso = int(input("Cunatos payasos hay en el ultimo pedido: "))
n_muñeca = int(input("Cunatas muñecas hay en el ultimo pedido: "))

peso = round(((n_payaso * payaso) + (n_muñeca * muñeca)) / 1000 , 2)
print(f"El paquete pesa {peso} kg.")